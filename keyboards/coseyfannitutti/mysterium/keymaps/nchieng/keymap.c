...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [1] = LAYOUT_tkl_ansi(
      RESET,            _______, _______, _______,_______,_______,_______,_______,_______, KC_MPRV, KC_MPLY,  _______, KC_MNXT,  _______,  _______, _______,
      ...
      _______, _______, _______, _______, RESET,  _______,_______,_______,_______,_______, _______, _______,  _______, _______,  _______,  _______, KC_VOLD,
